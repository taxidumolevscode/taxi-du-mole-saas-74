    ...
    <SiteChrome>
      <section className="rounded-[36px] border border-white/60 bg-white/70 p-5 shadow-[0_24px_60px_rgba(17,17,17,0.08)] backdrop-blur-xl md:p-8">
        ...
        <div className="mt-8 grid gap-5">
          ...
          <div className="rounded-[28px] border border-black/10 bg-white p-6">
            <h3 className="text-2xl font-semibold">4. Engagements De L&apos;Utilisateur</h3>
            <p className="mt-4 text-base leading-8 text-black/70">
              L&apos;utilisateur s&apos;engage à fournir des informations exactes,
              complètes et sincères lorsqu&apos;il contacte Taxi Du Môle. Il s&apos;engage
              également à ne pas utiliser le site à des fins frauduleuses,
              abusives ou contraires à la loi.
            </p>
          </div>
          ...
          <div className="rounded-[28px] border border-black/10 bg-white p-6">
            ...
            <p className="mt-4 text-base leading-8 text-black/70">
              Taxi Du Môle met tout en œuvre pour assurer un site fiable et à jour,
              sans garantir l&apos;absence d&apos;erreur, d&apos;interruption ou
              d&apos;indisponibilité. L&apos;utilisateur reconnaît utiliser le site sous sa
